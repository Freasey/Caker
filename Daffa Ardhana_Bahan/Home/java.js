...
const slideon=(hx)=>{
    if (hx===0) {
        ...
        document.getElementsByClassName('lokasi')[0].style.height='150px'
    }
    if (hx===1) {
        document.getElementsByClassName('lokasi')[0].style.height='40px';
...
const slideon1=(fx)=>{
    if (fx===0) {
        ...
        document.getElementsByClassName('lokasi')[1].style.height='150px';
        
    }
    if (fx===1) {
        
        document.getElementsByClassName('lokasi')[1].style.height='40px';
