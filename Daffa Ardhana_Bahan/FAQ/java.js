...
const boxos= document.getElementsByClassName('kotakfaq');
for (let xom = 0; xom < boxos.length; xom++) {
    boxos[xom].addEventListener('click',function(){
        this.classList.toggle('gas')
    })
